...
public final class HabitLogDao_Impl implements HabitLogDao {
      ...
      public List<HabitLogEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            final int _tmp_1;
            _tmp_1 = _cursor.getInt(_cursorIndexOfIsOngoing);
            _tmpIsOngoing = _tmp_1 != 0;
  ...
  @Override
  public Object getOngoingLogsForDate(final long date,
      final Continuation<? super List<HabitLogEntity>> $completion) {
    final String _sql = "SELECT * FROM habit_logs WHERE date = ? AND isOngoing = 1 AND isCompleted = 0";
  ...
  @Override
  public Object markOngoing(final long habitId, final long date,
      final Continuation<? super Unit> $completion) {
    return HabitLogDao.DefaultImpls.markOngoing(HabitLogDao_Impl.this, habitId, date, $completion);
  }

  @Override
  public Object completeOngoingAsDone(final long habitId, final long date,
      final Continuation<? super Unit> $completion) {
    return HabitLogDao.DefaultImpls.completeOngoingAsDone(HabitLogDao_Impl.this, habitId, date, $completion);
  }
