  ...
  public HabitDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfHabitEntity = new EntityInsertionAdapter<HabitEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `habits` (`id`,`systemId`,`title`,`frequencyType`,`targetCount`,`trackTimeEnabled`,`lastTimerDurationSeconds`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfHabitEntity = new EntityDeletionOrUpdateAdapter<HabitEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `habits` SET `id` = ?,`systemId` = ?,`title` = ?,`frequencyType` = ?,`targetCount` = ?,`trackTimeEnabled` = ?,`lastTimerDurationSeconds` = ? WHERE `id` = ?";
      }
      ...
      public List<HabitEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new HabitEntity(_tmpId,_tmpSystemId,_tmpTitle,_tmpFrequencyType,_tmpTargetCount,_tmpTrackTimeEnabled,_tmpLastTimerDurationSeconds);
            _result.add(_item);
          }
          return _result;
        } finally {
